...
import kotlinx.android.synthetic.uganda.fragment_status.android_version
import kotlinx.android.synthetic.uganda.fragment_status.app_version
import kotlinx.android.synthetic.uganda.fragment_status.current_user
import kotlinx.android.synthetic.uganda.fragment_status.data_last_fetched_at
import kotlinx.android.synthetic.uganda.fragment_status.data_last_synced_at
import kotlinx.android.synthetic.uganda.fragment_status.fetch_data_error
import kotlinx.android.synthetic.uganda.fragment_status.fetch_data_progress_bar
import kotlinx.android.synthetic.uganda.fragment_status.fetch_photos_error
import kotlinx.android.synthetic.uganda.fragment_status.fetch_photos_progress_bar
import kotlinx.android.synthetic.uganda.fragment_status.last_fetched_billables
import kotlinx.android.synthetic.uganda.fragment_status.last_fetched_diagnoses
import kotlinx.android.synthetic.uganda.fragment_status.last_fetched_member_photos
import kotlinx.android.synthetic.uganda.fragment_status.last_fetched_members
import kotlinx.android.synthetic.uganda.fragment_status.photos_last_fetched_at
import kotlinx.android.synthetic.uganda.fragment_status.photos_last_synced_at
import kotlinx.android.synthetic.uganda.fragment_status.sync_data_error
import kotlinx.android.synthetic.uganda.fragment_status.sync_data_progress_bar
import kotlinx.android.synthetic.uganda.fragment_status.sync_photos_error
import kotlinx.android.synthetic.uganda.fragment_status.sync_photos_progress_bar
import kotlinx.android.synthetic.uganda.fragment_status.unsynced_billables
import kotlinx.android.synthetic.uganda.fragment_status.unsynced_encounter_forms
import kotlinx.android.synthetic.uganda.fragment_status.unsynced_encounters
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getObservable().observe(this, Observer {
            it?.let { viewState ->
                ...
                unsynced_encounter_forms.setValue(formattedSyncQuantity(viewState.syncStatus.unsyncedEncounterFormsCount))
