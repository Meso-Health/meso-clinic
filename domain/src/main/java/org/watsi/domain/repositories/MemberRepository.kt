...
interface MemberRepository {
    ...
    fun byCardIds(names: List<String>): Single<List<MemberWithIdEventAndThumbnailPhoto>>
    ...
    fun fetchHouseholdIdByCardId(cardId: String): Flowable<UUID>
    fun fetchHouseholdIdByMembershipNumber(membershipNumber: String): Flowable<UUID>
