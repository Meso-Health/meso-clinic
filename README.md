...
| EthiopiaTraining | UNUSED              | blue   | http://localhost:5000                                                                                       | Rollbar         | manual                  | -                            |
| EthiopiaDemo     | demo’ing to funders | blue   | https://uhp-demo.watsi.org                                                                                  | Rollbar         | automatic (Google Play) | demo                         |
...
| UgandaSandbox    | QA                  | yellow | currently set to: https://coverage-ethiopia.herokuapp.com want: https://uhp-sandbox.watsi.org (deactivated) | Rollbar         | manual                  | -                            |
| UgandaTraining   | training users      | blue   | currently set to: http://localhost:5000 want: ?                                                             | Rollbar         | manual                  | -                            |
| UgandaDemo       | UNUSED              | blue   | https://uhp-demo.watsi.org                                                                                  | Rollbar         | manual                  | -                            |
